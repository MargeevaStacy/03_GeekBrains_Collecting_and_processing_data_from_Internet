...
serials_list = soup.findAll('div',{'class':'desktop-rating-selection-film-item'})
...
for serial in serials_list:
    ...
    serial_genre = serial.findAll('span',{'class':'selection-film-item-meta__meta-additional-item'})[-1].text
